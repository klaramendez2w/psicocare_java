						...
						<div id="tunombre" class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input autofocus type="text" class="form-control" name="name" id="name" placeholder="Enter your Name"
									 minlength="3" required />
									<div id="errorname" class="error hide">Introduce un nombre más largo</div>
								</div>
							</div>
						</div>
						...
						<div id="tuusuario" class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<div id="errorusuario" class=" error hide">introduce un nombre de usuario correcto</div>
								</div>
							</div>
						</div>
						...
						<div id="tupassword" class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="password" class="form-control" name="password" id="password" placeholder="Enter your Password" minlength="4" maxlength="10"
									 pattern="[a-zA-Z0-9]*" required />
									<div id="errorpassword" class=" error hide">Introduce un password correcto. El formato de password no es
										válido</div>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="password" class="form-control" name="confirm" id="confirm" placeholder="Confirm your Password"
									 pattern="[a-zA-Z0-9]*" required />
									<div id="passwordnomatch" class="error hide">el password no coincide</div>
								</div>
							</div>
						</div>
